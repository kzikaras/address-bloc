...
RSpec.describe AddressBook do
    ...
    describe "#import_from_csv" do
        describe "File number one" do
            # tests for entries.csv
            it "imports the correct number of entries from entries" do
                # #3
        ...
        describe 'import #2' do
            ...
            it "imports the 1st entry from entries_2.csv" do
                ...
                check_entry(entry_one, "Kurt", "203-823-8420", "kurtzikaras@gmail.com")
            end

            it "imports the 2nd entry from entries_2.csv" do
                book.import_from_csv("entries_2.csv")
                entry_two = book.entries[2]
                check_entry(entry_two, "Sam", "917-877-7473", "srgigante88@gmail.com")
            end

            it "imports the 3rd entry from entries_2.csv" do
                book.import_from_csv("entries_2.csv")
                entry_three = book.entries[0]
                check_entry(entry_three, "Jamie", "203-522-0388", "jotfinoski@gmail.com")
            end
        end
